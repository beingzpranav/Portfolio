              ...
              {[
                ...
                >
                  <a 
                    ...
                    className="text-white/90 hover:text-[#0EA5E9] transition-colors flex items-center gap-2 text-xs sm:text-sm py-1"
            ...
            <div className="flex flex-col gap-3 max-w-xs mx-auto lg:mx-0">
              ...
              >
                <motion.svg 
                  ...
                  viewBox="0 0 24 24" 
                  fill="currentColor"
                  animate={window.innerWidth > 768 ? { rotate: [0, 5, -5, 0] } : {}}
